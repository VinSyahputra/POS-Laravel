    ...
    <main class="h-full flex-1 overflow-y-auto p-4 md:p-6">
        <div class="mb-3 flex items-center gap-3 md:hidden">
            ...
            <span class="text-sm font-bold text-slate-600"
                x-text="$store.ui.tab === 'cashier' ? 'Kasir' : ($store.ui.tab === 'menu' ? 'Food Court Menu' : ($store.ui.tab === 'history' ? 'Riwayat Transaksi' : ($store.ui.tab === 'budget' ? 'Generate Nota dari Budget' : 'Pengaturan Printer')))"></span>
        </div>
        ...
        <section x-show="$store.ui.tab === 'budget'" x-cloak class="h-full overflow-y-auto">
            <div x-data="budgetGenerator" class="mx-auto flex max-w-2xl flex-col gap-4">
                <h1 class="hidden text-xl font-bold md:block md:text-2xl">Generate Nota dari Budget</h1>
